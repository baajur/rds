...
extern {
    ...
    fn cblas_scasum (n : isize, x : *const Complex32, incx : isize) -> libc::c_float;
    fn cblas_dzasum (n : isize, x : *const Complex64, incx : isize) -> libc::c_double;
    ...
    fn cblas_scnrm2 (n : isize, x : *const Complex32, incx : isize) -> libc::c_float;
    fn cblas_dznrm2 (n : isize, x : *const Complex64, incx : isize) -> libc::c_double;
    ...
    fn cblas_cscal (n : isize, a : *const Complex32, x : *mut Complex32, incx : isize) -> libc::c_void;
    fn cblas_zscal (n : isize, a : *const Complex64, x : *mut Complex64, incx : isize) -> libc::c_void;
    ...
    fn cblas_caxpy (n : isize, a : *const Complex32, x : *const Complex32, incx : isize, y : *mut Complex32, incy : isize) -> libc::c_void;
    fn cblas_zaxpy (n : isize, a : *const Complex64, x : *const Complex64, incx : isize, y : *mut Complex64, incy : isize) -> libc::c_void;
    ...
    fn cblas_cdotu_sub (n : isize, x : *const Complex32, incx : isize, y : *const Complex32, incy : isize, dotu : *mut Complex32) -> libc::c_void;
    fn cblas_zdotu_sub (n : isize, x : *const Complex64, incx : isize, y : *const Complex64, incy : isize, dotu : *mut Complex64) -> libc::c_void;
    ...
    fn cblas_cgemv (layout : libc::c_int, trans : libc::c_int, m : isize, n : isize, alpha : *const Complex32, a : *const Complex32, lda : isize, x : *const Complex32, incx : isize, beta : *const Complex32, y : *mut Complex32, incy : isize) -> libc::c_void;
    fn cblas_zgemv (layout : libc::c_int, trans : libc::c_int, m : isize, n : isize, alpha : *const Complex64, a : *const Complex64, lda : isize, x : *const Complex64, incx : isize, beta : *const Complex64, y : *mut Complex64, incy : isize) -> libc::c_void;
    ...
    fn cblas_cgemm (layout : libc::c_int, transa : libc::c_int, transb : libc::c_int, m : isize, n : isize, k : isize, alpha : *const Complex32, a : *const Complex32, lda : isize, b : *const Complex32, ldb : isize, beta : *const Complex32, c : *mut Complex32, ldc : isize) -> libc::c_void;
    fn cblas_zgemm (layout : libc::c_int, transa : libc::c_int, transb : libc::c_int, m : isize, n : isize, k : isize, alpha : *const Complex64, a : *const Complex64, lda : isize, b : *const Complex64, ldb : isize, beta : *const Complex64, c : *mut Complex64, ldc : isize) -> libc::c_void;
}
...
impl<R> Blas<Complex32> for R where R : NDDataMut<Complex32> {

    fn asum(&self) -> Complex32 {
        unsafe {
            Complex32::new(cblas_scasum(self.size() as isize, self.get_data().as_ptr(), 1),0.0)
        }
    }

    fn nrm2(&self) -> Complex32 {
        unsafe {
            Complex32::new(cblas_scnrm2(self.size() as isize, self.get_data().as_ptr(), 1),0.0)
        }
    }

    fn scal(&mut self, a : Complex32) {
        unsafe {
            cblas_cscal(self.size() as isize, &a, self.get_data_mut().as_mut_ptr(), 1);
        }
    }

    fn axpy(&mut self, a : Complex32, x : &NDData<Complex32>) {
        if self.dim() != x.dim() {
            panic!("Blas::axpy(): x is not of the same dimension ({} != {})",  x.dim(), self.dim());
        }
    ...
    fn dot(&self, x : &NDData<Complex32>) -> Complex32 {
        if self.dim() != 1 || x.dim() != 1{
            panic!("Blas::dot(): x or self is not in 1 dimension ({} != 1 || {} != 1)",  x.dim(), self.dim());
        }
        let mut dotu = Complex32::new(0.0,0.0);
        unsafe {
    ...
    #[allow(unused_assignments)]
    fn gemv(&mut self, alpha : Complex32, a : &NDData<Complex32>, x : &NDData<Complex32>, beta : Complex32) {
        if self.dim() != 1 || a.dim() != 2 {
            panic!("Blas::gemv(): self is not in 1 dimension or a is not in 2 dimension({} != 1 || {} != 2)", self.dim(), x.dim());
        }
    ...
    #[allow(unused_assignments)]
    fn gemm(&mut self, alpha : Complex32, a : &NDData<Complex32>, b : &NDData<Complex32>, beta : Complex32) {
        if self.dim() != 2 || a.dim() != 2 || b.dim() != 2 {
            panic!("Blas::gemm(): a, b or c is not in 2 dimension({} != 2 || {} != 2 || {} != 2)", a.dim(), b.dim(), self.dim());
        }
...
impl<R> Blas<Complex64> for R where R : NDDataMut<Complex64> {

    fn asum(&self) -> Complex64 {
        unsafe {
            Complex64::new(cblas_dzasum(self.size() as isize, self.get_data().as_ptr(), 1),0.0)
        }
    }

    fn nrm2(&self) -> Complex64 {
        unsafe {
            Complex64::new(cblas_dznrm2(self.size() as isize, self.get_data().as_ptr(), 1),0.0)
        }
    }

    fn scal(&mut self, a : Complex64) {
        unsafe {
            cblas_zscal(self.size() as isize, &a, self.get_data_mut().as_mut_ptr(), 1);
        }
    }

    fn axpy(&mut self, a : Complex64, x : &NDData<Complex64>) {
        if self.dim() != x.dim() {
            panic!("Blas::axpy(): x is not of the same dimension ({} != {})",  x.dim(), self.dim());
        }
    ...
    fn dot(&self, x : &NDData<Complex64>) -> Complex64 {
        if self.dim() != 1 || x.dim() != 1{
            panic!("Blas::dot(): x or self is not in 1 dimension ({} != 1 || {} != 1)",  x.dim(), self.dim());
        }
        let mut dotu = Complex64::new(0.0,0.0);
        unsafe {
    ...
    #[allow(unused_assignments)]
    fn gemv(&mut self, alpha : Complex64, a : &NDData<Complex64>, x : &NDData<Complex64>, beta : Complex64) {
        if self.dim() != 1 || a.dim() != 2 {
            panic!("Blas::gemv(): self is not in 1 dimension or a is not in 2 dimension({} != 1 || {} != 2)", self.dim(), x.dim());
        }
    ...
    #[allow(unused_assignments)]
    fn gemm(&mut self, alpha : Complex64, a : &NDData<Complex64>, b : &NDData<Complex64>, beta : Complex64) {
        if self.dim() != 2 || a.dim() != 2 || b.dim() != 2 {
            panic!("Blas::gemm(): a, b or c is not in 2 dimension({} != 2 || {} != 2 || {} != 2)", a.dim(), b.dim(), self.dim());
        }
